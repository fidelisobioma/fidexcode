        ...
        <div className="max-w-[600px] order-2 text-center md:text-left">
          ...
          <ScrollReveal>
            <p className="text-base font-normal leading-relaxed text-gray-800">
              I'm fidelis, a skilled Frontend developer. I specialise in
              building fast, accessible, and user-friendly web applications
              using React JS and Tailwind css, with a strong foundation in HTML,
              CSS, and JavaScript. I craft seamless digital experiences that
